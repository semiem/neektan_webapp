...
function TimerPage(counter) {
  ...
  return (
    <div className="h-screen w-full sm:w-4/12 flex flex-col justify-between items-center gap-10 mx-auto overflow-x-hidden backgroundColor1">
      ...
      <div className="w-48 h-48 min-h-[12rem] bg-timer-gradient rounded-full flex justify-center items-center ring-4 ring-gray-800 ring-offset-0">
      ...
      <div className="w-full rounded-md bg-[#15233c] py-8 flex flex-col gap-8">
        ...
        <div className="w-full flex justify-around items-end gap-8">
          ...
          <div className="flex w-28 h-[100px] -mb-3 flex-col items-center justify-center gap-1 rounded-xl bg-[#101a2c]">
